function [wayPoints,orientationZ,TPath,trajTimes,waypointTimes,twp] = getPathPlanner_App(h_s,n_s,T0,Tf,numPoints,numJoints,robotData)
...
% Getting orientations for waypoints
orientationZ = zeros(3,numPoints);
for i=1:numPoints
    orientationZ(:,i) = getZ(TPath(:,:,i));
end
